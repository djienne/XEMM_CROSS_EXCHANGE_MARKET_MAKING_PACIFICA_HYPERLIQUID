...
/// IN PARALLEL to maximize speed and redundancy. Both methods are attempted
...
pub async fn dual_cancel(
    ...
    // Execute REST and WebSocket cancellations in parallel for minimum latency
    ...
    // Extract counts, logging any failures
